...
function CashierPage() {
  ...
  // --- STATE BARU UNTUK FILTER & PENCARIAN ---
  ...
  // --- LOGIKA BARU UNTUK FILTER & PENCARIAN ---
  const uniqueCategories = useMemo(() => {
    const categories = menus.map(menu => menu.Category).filter(Boolean); // filter(Boolean) untuk hapus string kosong
  ...
  const handleProcessTransaction = async () => {
    ...
    try {
      await createTransaction(itemsToSubmit);
